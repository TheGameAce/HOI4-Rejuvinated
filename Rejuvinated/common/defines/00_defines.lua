...
NProduction = {
	...
	FLOATING_HARBOR_MAX_NAV_FACTORIES_PER_LINE = 15,
	...
	BASE_COUNTRY_ENERGY_PRODUCTION = 12.0, 			-- The base energy production of a country
	ENERGY_SCALING_COST_BY_FACTORY_COUNT = 0.0225, -- Scales energy cost based on the total number of factories
	BASE_ENERGY_COST = 0.15,						-- How much energy per factory consumes
	ENERGY_COST_CAP = 4,						-- Maximum energy cost per factory
	ENERGY_SCALE_PER_TRADE_FACTORY_EXPORT = 0.10, -- Factor of how many of the factories gained from trade is affects the energy cost scaling
	...
	EQUIPMENT_BASE_LEND_LEASE_WEIGHT = 0.5, -- Base equipment lend lease weight
...
NProject = {
	...
	SCIENTIST_BASIC_RESEARCH_DAILY_XP_GAIN = 0.33,	-- Daily experience gain for doing basic research
